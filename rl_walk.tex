...
First, we define the format of a policy file as in Figure~\ref{fig:policy_def}:
...
\item[Action] -- A single value of type \textit{Action} which defines what action to take. The \textit{Action} type is defined in the codebase, and currently is simply an integer value.
